...
#ifndef __GENERATED_php$$classes$$exception$_h__
#define __GENERATED_php$$classes$$exception$_h__
...
Variant pm_php$$classes$$exception$_php(bool incOnce, LVariableTable* variables, Globals *globals);
...
#endif // __GENERATED_php$$classes$$exception$_h__
