...
#ifndef __GENERATED_php$$classes$$iterator$_h__
#define __GENERATED_php$$classes$$iterator$_h__
...
Variant pm_php$$classes$$iterator$_php(bool incOnce, LVariableTable* variables, Globals *globals);
...
#endif // __GENERATED_php$$classes$$iterator$_h__
