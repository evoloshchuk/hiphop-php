...
#ifndef __GENERATED_php$$classes$$reflection$_h__
#define __GENERATED_php$$classes$$reflection$_h__
...
Variant pm_php$$classes$$reflection$_php(bool incOnce, LVariableTable* variables, Globals *globals);
...
#endif // __GENERATED_php$$classes$$reflection$_h__
