...
#ifndef __GENERATED_cls$$InvalidArgumentException$_h__
#define __GENERATED_cls$$InvalidArgumentException$_h__
...
#endif // __GENERATED_cls$$InvalidArgumentException$_h__
