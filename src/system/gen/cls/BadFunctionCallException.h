...
#ifndef __GENERATED_cls$$BadFunctionCallException$_h__
#define __GENERATED_cls$$BadFunctionCallException$_h__
...
#endif // __GENERATED_cls$$BadFunctionCallException$_h__
