...
#ifndef __GENERATED_cls$$UnexpectedValueException$_h__
#define __GENERATED_cls$$UnexpectedValueException$_h__
...
#endif // __GENERATED_cls$$UnexpectedValueException$_h__
