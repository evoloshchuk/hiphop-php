...
#ifndef __GENERATED_cls$$RecursiveDirectoryIterator$_h__
#define __GENERATED_cls$$RecursiveDirectoryIterator$_h__
...
#endif // __GENERATED_cls$$RecursiveDirectoryIterator$_h__
