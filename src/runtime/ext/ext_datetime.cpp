...
const int64 q_DateTimeZone$$AFRICA      = TimeZone::AFRICA;
const int64 q_DateTimeZone$$AMERICA     = TimeZone::AMERICA;
const int64 q_DateTimeZone$$ANTARCTICA  = TimeZone::ANTARCTICA;
const int64 q_DateTimeZone$$ARCTIC      = TimeZone::ARCTIC;
const int64 q_DateTimeZone$$ASIA        = TimeZone::ASIA;
const int64 q_DateTimeZone$$ATLANTIC    = TimeZone::ATLANTIC;
const int64 q_DateTimeZone$$AUSTRALIA   = TimeZone::AUSTRALIA;
const int64 q_DateTimeZone$$EUROPE      = TimeZone::EUROPE;
const int64 q_DateTimeZone$$INDIAN      = TimeZone::INDIAN;
const int64 q_DateTimeZone$$PACIFIC     = TimeZone::PACIFIC;
const int64 q_DateTimeZone$$UTC         = TimeZone::UTC;
const int64 q_DateTimeZone$$ALL         = TimeZone::ALL;
const int64 q_DateTimeZone$$ALL_WITH_BC = TimeZone::ALL_WITH_BC;
const int64 q_DateTimeZone$$PER_COUNTRY = TimeZone::PER_COUNTRY;
